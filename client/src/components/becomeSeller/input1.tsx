    ...
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 w-full sm:px-7 md:px-16 px-0 pt-8">
        ...
        focus:ring-gray-800 focus:border-gray-700 block w-full p-2.5"
          ...
          {errorUserName ? (
            <p className="mt-2 text-sm text-red-600 dark:text-red-500">
              <span className="font-medium">Erreur: </span> {errorUserName}
            </p>
          ) : (
            <></>
          )}
        ...
        <div className="w-full">
          ...
          {errorPhone ? (
            <p className="mt-2 text-sm text-red-600 dark:text-red-500">
              <span className="font-medium">Erreur</span> {errorPhone}
            </p>
          ) : (
            <></>
          )}
        ...
        focus:ring-gray-600 focus:border-gray-700 block w-full p-2.5 cursor-pointer text-left"
            onClick={(e: React.MouseEvent<HTMLButtonElement>) => {
              window.open(`https://wa.me/+212${phone}`, "_blank");
            }}
          >{`https://wa.me/+212${phone ? phone : ""}`}</button>
        </div>
      </div>
      <button
        className={`${

...
const Content0: React.FC<content0> = ({
  userData,
  setAdresse,
  setCity,
  setPhone,
  ...
  return (
    <div className="my-2 flex flex-col">
      ...
      <label
        htmlFor="ville"
        className="pl-1 mt-2 text-sm font-medium text-gray-900"
      >
        Ville :
      </label>
      <button
      ...
      {cityErr !== "" ? errMsg(cityErr) : null}
      {/*  */}
      <>
        <label className="pl-1 font-normal mt-2">Adresse (optionnel) :</label>
        ...
        <div className="grid sm:grid-cols-2 sm:gap-10 gap-3 items-center">
          ...
          <div className="flex flex-row  items-center w-full pl-2">
            {/* <div
              ...
              > */}
            <svg className="w-7 h-7" viewBox="0 0 640 512">
            ...
            <div className="text-sm pl-3">Masquer le numéro dans l'annonce</div>
